    ...
    <div className="flex justify-between container ">
      <div className="m-auto container">
        <div className="relative flex items-center justify-start mt-5">
          <button
            onClick={ext}
            className="absolute top-1/2 left-4 -translate-y-1/2 border border-blue-100 shadow-md rounded-full p-3 bg-white active:translate-x-1 transition"
          >
            <ArrowLeft04Icon />
          </button>
          ...
          <button
            onClick={next}
            className="absolute top-1/2 right-4 -translate-y-1/2 border border-blue-100 shadow-md rounded-full p-3 bg-white active:translate-x-1 transition"
          >
            <ArrowRight02Icon />
          </button>
        </div>
      ...
      <div className="w-[400px] mt-5 ml-5 border-2 border-red-700 rounded-2xl">
          <CaruselCard />
      </div>
    </div>
  );
